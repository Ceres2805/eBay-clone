...
export default function MoneyBack() {
  return (
    <section
    className="flex flex-row items-center p-10 bg-gray-100 h-90 pl-18"
    style={{ backgroundImage: "url('/footer-bg.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
    <div className="ml-2 text-white">
    <h2 className="text-3xl font-bold">Get your order or your money</h2>
    <h2 className="text-3xl font-bold">back</h2>
    <p className="mt-2 mb-2">Shop confidently with eBay Money Back Guarantee.</p>
